...
public class SheHui_Fragment extends Fragment implements XListView.IXListViewListener {

    private View view;
    private XListView xlistview;
    private String path = "http://v.juhe" +
            ".cn/toutiao/index?type=shehui&key=6dde6de11cc04328c65963b2951dc8b5";
    private boolean boo;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable
        ...
        view = View.inflate(getContext(), R.layout.fragment_shehui, null);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        xlistview = (XListView) view.findViewById(R.id.shehui_xlv);
