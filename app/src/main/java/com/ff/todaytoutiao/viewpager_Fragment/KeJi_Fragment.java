...
public class KeJi_Fragment extends Fragment implements XListView.IXListViewListener {

    private View view;
    private XListView xlistview;
    private String path = "http://v.juhe" +
            ".cn/toutiao/index?type=keji&key=6dde6de11cc04328c65963b2951dc8b5";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable
        ...
        view = View.inflate(getContext(), R.layout.fragment_keji, null);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        xlistview = (XListView) view.findViewById(R.id.keji_xlv);
