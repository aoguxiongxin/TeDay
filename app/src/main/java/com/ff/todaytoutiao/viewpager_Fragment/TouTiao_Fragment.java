...
public class TouTiao_Fragment extends Fragment implements XListView.IXListViewListener {

    private View view;
    private XListView xlistview;
    private String path = "http://v.juhe" +
            ".cn/toutiao/index?type=top&key=6dde6de11cc04328c65963b2951dc8b5";
    private boolean boo;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable
        ...
        view = View.inflate(getContext(), R.layout.fragment_toutiao, null);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        xlistview = (XListView) view.findViewById(R.id.toutiao_xlv);
